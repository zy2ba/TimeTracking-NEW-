 ...
 */
@Entity
@Table(name = "KURS_PROJECT")
public class KursProject implements SettableActivity,TimeTableElement{
    /**
    ...
    private static final double factor = 4;
    ...
    public String getName() {
        return ("Курсовые проекты "+String.format("%.2g",(double)factor*peoplesNum)+" часов");
    }
